...
aod_dir = "C:/Users/zy125/Box Sync/Postdoc/GAAP/aod"
...
shanghai_boun<-st_read("C:/Users/zy125/Box Sync/Postdoc/GAAP/GIS data/boundary_sh_poly.shp")

p_clipped<-st_intersection(p_geo, shanghai_boun)
